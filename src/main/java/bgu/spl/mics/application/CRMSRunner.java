...
public class CRMSRunner {
    ...
    public static void main(String[] args) {
        ...
        File input = new File("C:/Users/nadav/Downloads/input.json");
        try {
        ...
        for(Conference conference: allConferences){
            ...
            for (Model model : conference.getGoodModels()){
                System.out.println();
...
//        Data BertDATA = new Data("Text", 1000);
...
//        Thread threadTimeService = new Thread(new TimeService(1, 60));
//
